...
export const SETTING_RULES: Record<string, SettingRule> = {
  ...
  [SETTING_KEY.RETENTION_ENABLED]: { kind: 'boolean', defaultValue: 'true' },
  ...
  [SETTING_KEY.ATTENDANCE_RETENTION_DAYS]: { kind: 'int', defaultValue: '90', min: 1, max: 3650 },
...
export const MODULE5_SEED_SETTINGS: Array<{ key: string; value: string }> = [
  ...
  { key: SETTING_KEY.RETENTION_ENABLED, value: 'true' },
