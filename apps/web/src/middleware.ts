...
export function middleware(request: NextRequest) {
  ...
  if (!hasSession && !isPublic && pathname !== '/') {
    ...
    if (pathname.startsWith('/home') || pathname.startsWith('/dashboard') || pathname.startsWith('/reports') || pathname.startsWith('/projects') || pathname.startsWith('/muster') || pathname.startsWith('/shifts') || pathname.startsWith('/users') || pathname.startsWith('/devices') || pathname.startsWith('/access-control') || pathname.startsWith('/settings') || pathname.startsWith('/departments') || pathname.startsWith('/zones') || pathname.startsWith('/evac')) {
