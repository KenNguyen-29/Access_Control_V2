...
import { rolesRequiringProjects } from '@/lib/permissions';
...
export default function AccountsSettingsPage() {
  ...
  return (
    <PageShell
      ...
      subtitle="Quản lý tài khoản đăng nhập, vai trò và phạm vi dự án."
      actions={
        <>
          <Link
            href="/settings"
      ...
      >
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="max-h-40 space-y-2 overflow-y-auto rounded-sm border border-border p-3">
              {projects.length === 0 && (
